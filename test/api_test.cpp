...
inline static std::atomic<bool> windowShouldClose = false;
...
void printExportedSymbols(HMODULE module) {
...
int main() {
...

  {
    ...
    for (u32 i = 0; i < queueFamilyCount; ++i ) {
      ...
      pCheckpointProps[i].sType = VK_STRUCTURE_TYPE_QUEUE_FAMILY_CHECKPOINT_PROPERTIES_2_NV;
