...
#define VK_inline_bitflag(flag_) inline constexpr static bitflag<bit_type> flag_ = bit_type::flag_
...
namespace valkyrie::Spv{
  ...
  class ImageOperand : public bitflag<Bits::ImageOperand> {
  public:
    using enum_type = ImageOperand;
    using bit_type = Bits::ImageOperand;

    using bitflag<Bits::ImageOperand>::bitflag;
  ...
  class SelectionControl : public bitflag<Bits::SelectionControl> {
  public:
    using enum_type = SelectionControl;
    using bit_type = Bits::SelectionControl;

    using bitflag<Bits::SelectionControl>::bitflag;

    VK_inline_bitflag(Flatten);
    VK_inline_bitflag(DontFlatten);
  };

  class LoopControl : public bitflag<Bits::LoopControl> {
  public:
    using enum_type = LoopControl;
    using bit_type = Bits::LoopControl;

    using bitflag<Bits::LoopControl>::bitflag;
  ...
  class FunctionControl : public bitflag<Bits::FunctionControl> {
  public:
    using enum_type = FunctionControl;
    using bit_type = Bits::FunctionControl;

    using bitflag<Bits::FunctionControl>::bitflag;
  ...
  class MemorySemantics : public bitflag<Bits::MemorySemantics> {
  public:
    using enum_type = MemorySemantics;
    using bit_type = Bits::MemorySemantics;

    using bitflag<Bits::MemorySemantics>::bitflag;
  ...
  class MemoryAccess : public bitflag<Bits::MemoryAccess> {
  public:
    using enum_type = MemoryAccess;
    using bit_type = Bits::MemoryAccess;

    using bitflag<Bits::MemoryAccess>::bitflag;
  ...
  class KernelProfilingInfo : public bitflag<Bits::KernelProfilingInfo> {
  public:
    using enum_type = KernelProfilingInfo;
    using bit_type = Bits::KernelProfilingInfo;

    using bitflag<Bits::KernelProfilingInfo>::bitflag;
  ...
  class Ray : public bitflag<Bits::Ray>{
  public:
    using enum_type = Ray;
    using bit_type  = Bits::Ray;

    using bitflag<Bits::Ray>::bitflag;
  ...
  namespace Reflect{
    ...
    class Type : public bitflag<Bits::ReflectType> {
    public:
      using bitflag<Bits::ReflectType>::bitflag;
    ...
    class Decoration : public bitflag<Bits::ReflectDecoration> {
    public:
      using bitflag<Bits::ReflectDecoration>::bitflag;
    ...
    class Variable : public bitflag<Bits::ReflectVariable>{
    public:
      using enum_type = Variable;
      using bit_type = Bits::ReflectVariable;

      using bitflag<Bits::ReflectVariable>::bitflag;
    ...
    class ShaderStage : public bitflag<Bits::ReflectShaderStage>{
    public:
      using enum_type = ShaderStage;
      using bit_type = Bits::ReflectShaderStage;

      using bitflag<Bits::ReflectShaderStage>::bitflag;
