...
namespace valkyrie::Core{
  ...
  protected:
    ...
    using       status_ref     = StatusCode<void>&;
    using const_status_ref     = const StatusCode<void>&;
    ...
    virtual Core::StringView   doGetName() const noexcept = 0;
  ...
  public:
    ...
    VK_nodiscard Core::StringView name() const noexcept {
      return doGetName();
    }
  ...
  namespace Detail{
    ...
    public:
      ...
      inline constexpr static Uuid uuid{"a0e47cda-193a-4d65-b33b-f74139dcc098"};

      using value_type = std::nullptr_t;
      using status_type = GenericStatus;


      Core::StringView doGetName() const noexcept override {
  ...
  public:
    ...
    inline constexpr static Uuid uuid{"6cc65ad7-e56b-48a2-9562-6f7cb860a656"};
