...
namespace valkyrie::Graphics::API{
  ...
  class CommandPool{
    ...
    Core::AgentMailbox urgentMailbox;
    Core::AgentMailbox normalMailbox;
    Core::AgentMailbox lazyMailbox;
  ...
  public:
    ...
    Result<CommandBuffer> makePrimaryCommandBuffer() noexcept;
    Result<CommandBuffer> makeSecondaryCommandBuffer() noexcept;
  ...
  class CommandBuffer{
    ...
    Impl* pImpl;
  public:
    CommandBuffer(CommandPool& pool) noexcept;
