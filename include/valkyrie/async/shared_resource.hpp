...
namespace valkyrie{
  ...
  namespace detail{
    ...
    template <typename M> requires(requires(M& mutex/*, Allocator& alloc*/){
      { mutex.clone() } -> raw_pointer<M>;
  /*  { mutex.clone(alloc) } -> Pointer<M>;  */
      { mutex.readLock() } noexcept -> exact_same_as<void>;
      { mutex.readUnlock() } noexcept -> exact_same_as<void>;
      { mutex.tryReadLock() } noexcept -> exact_same_as<bool>;
    })
    ...
    template <typename M> requires(requires(M& mutex/*, Allocator& alloc*/){
      { mutex.clone() } -> raw_pointer<M>;
      /*  { mutex.clone(alloc) } -> Pointer<M>;  */
      { mutex.writeLock() } noexcept -> exact_same_as<void>;
      { mutex.writeUnlock() } -> exact_same_as<void>;
      { mutex.tryWriteLock() } -> exact_same_as<bool>;
    })
