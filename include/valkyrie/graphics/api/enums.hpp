...
namespace valkyrie::Traits{
  ...
  struct BitFlagEnum<graphics::api::FlagBits::CullMode>{
    ...
    inline constexpr static string_view name{VK_string("CullMode")};
    inline constexpr static string_view scoped_name{VK_string("valkyrie::graphics::api::FlagBits::CullMode")};
...
#define VK_declare_flag_type(Type) class Type##Flags : public CRTPBitFlags<Type##Flags, FlagBits::Type>{ \
    using Base_ = CRTPBitFlags<Type##Flags, FlagBits::Type>;                                             \
  public:                                                                                                      \
    using Base_::Base_;                                                                                        \
