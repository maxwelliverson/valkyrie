...
template <typename ...Types>
struct std::tuple_size<valkyrie::MultiIterator<Types...>> : std::integral_constant<size_t, sizeof...(Types)>{};
template <size_t N, typename ...Types>
struct std::tuple_element<N, valkyrie::MultiIterator<Types...>> : std::tuple_element<N, std::tuple<Types...>>{};

template <typename ...Types>
struct std::tuple_size<std::reverse_iterator<valkyrie::MultiIterator<Types...>>> : std::integral_constant<size_t, sizeof...(Types)>{};
template <size_t N, typename ...Types>
struct std::tuple_element<N, std::reverse_iterator<valkyrie::MultiIterator<Types...>>> : std::tuple_element<N, std::tuple<Types...>>{};
