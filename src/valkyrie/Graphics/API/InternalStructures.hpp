...
namespace valkyrie::Graphics::API::Internal{
  ...
  struct Layer{
    ...
    LayerID           id;
    Core::Version     specVersion;
    Core::Version     implementationVersion;
    bool              isEnabled;
  };
  ...
  struct InstanceImpl{
    ...
    mutable Core::FlatSet<Layer>             layers;
    mutable Core::FlatSet<InstanceExtension> extensions;

    Core::SmallArray<PhysicalDeviceImpl, 4> physicalDevices;
