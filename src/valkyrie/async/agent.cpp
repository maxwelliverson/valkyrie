...
namespace {
  ...
  using system_status = status_code<SystemDomain>;
  using system_error  = error_code<SystemDomain>;


  template<typename T>
  using Win32Maybe = maybe<T, SystemDomain>;
  ...
  public:
    ...
    Win32Result(system_status &&stat) : Win32Maybe<T>(std::move(stat)) {}
  ...
  struct IteratorPlaceholder{
    char buffer[sizeof(typename Colony<IteratorPlaceholderSizer>::iterator)]{};
  };

  using MessageHookContainer = Colony<MessageHook>;
  ...
  struct MessageHook{
    ...
    MessageHook() = default;
    MessageHook(PFN_processMessage msgHook, void* pUserData) noexcept
  ...
  struct MessageHooks{
    ...
    void addPreHook(HookKey hookKey, PFN_processMessage pFunction, void* pUserData) {
    ...
    void addPostHook(HookKey hookKey, PFN_processMessage pFunction, void* pUserData) {
  ...
  inline constexpr AgentConcurrency ConcurrencySPSC{ 0 };
  inline constexpr AgentConcurrency ConcurrencyMPSC{ AgentConcurrency::MultiProducer };
  inline constexpr AgentConcurrency ConcurrencySPMC{ AgentConcurrency::MultiConsumer };
  inline constexpr AgentConcurrency ConcurrencyMPMC{ (u32)AgentConcurrency::MultiProducer | (u32)AgentConcurrency::MultiConsumer };
  inline constexpr AgentConcurrency ConcurrencySPMCNonCoherent{ AgentConcurrency::OutOfOrderConsumption };
  inline constexpr AgentConcurrency ConcurrencyMPMCNonCoherent{ (u32)AgentConcurrency::MultiProducer | (u32)AgentConcurrency::OutOfOrderConsumption };
}

AgentMailbox::Interface AgentMailbox::dispatchInterface(AgentConcurrency concurrency) noexcept {
  switch (concurrency) {
    case ConcurrencySPSC:
      return { &AgentMailbox::writeMessageSPSC, &AgentMailbox::readMessageSC, &AgentMailbox::tryReadMessageSC };
...
valkyrie::AgentMailbox&                        valkyrie::AgentMailbox::operator=(AgentMailbox && other) noexcept {
  this->~AgentMailbox();
...
valkyrie::AgentResult<valkyrie::AgentMessage*> valkyrie::AgentMailbox::writeMessageSPSC(function_ref<AgentMessage*(void*)> fnCtor, u64 msgSize) noexcept {
...
valkyrie::AgentResult<valkyrie::AgentMessage*> valkyrie::AgentMailbox::writeMessageMPSC(function_ref<AgentMessage*(void*)> fnCtor, u64 msgSize) noexcept {
...
valkyrie::AgentResult<valkyrie::AgentMessage*> valkyrie::AgentMailbox::writeMessageSPMC(function_ref<AgentMessage*(void*)> fnCtor, u64 msgSize) noexcept {
  u32 writeOffset = nextWriteOffset.load(std::memory_order_acquire);
  u32 nextOffset;
  AgentMessage* pMessage;
...
valkyrie::AgentResult<valkyrie::AgentMessage*> valkyrie::AgentMailbox::writeMessageSPMCNonCoherent(function_ref<AgentMessage*(void*)> fnCtor, u64 msgSize) noexcept {
  u32 writeOffset = nextWriteOffset.load();
...
valkyrie::AgentResult<valkyrie::AgentMessage*> valkyrie::AgentMailbox::writeMessageMPMC(function_ref<AgentMessage*(void*)> fnCtor, u64 msgSize) noexcept {
  u32 writeOffset = nextWriteOffset.load();
  u32 firstReadOffset = syncMarker.load();
  u32 nextOffset;
  AgentMessage* pMessage;
...
valkyrie::AgentStatus                          valkyrie::AgentMailbox::readMessageSC (function_ref<AgentStatus(AgentMessage&)> msgProc) noexcept {
...
valkyrie::AgentStatus                          valkyrie::AgentMailbox::readMessageMC (function_ref<AgentStatus(AgentMessage&)> msgProc) noexcept {
...
valkyrie::AgentStatus                          valkyrie::AgentMailbox::readMessageNonCoherent (function_ref<AgentStatus(AgentMessage&)> msgProc) noexcept {
  u32 readOffset;
  u32 nextOffset = 0;
  AgentMessage* pMessage;
...
valkyrie::AgentStatus                          valkyrie::AgentMailbox::tryReadMessageSC (function_ref<AgentStatus(AgentMessage&)> msgProc) noexcept {
  u32 readOffset = nextReadOffset.load();
  u32 nextOffset;
  AgentMessage* pMessage;

  if (nextWriteOffset.load(std::memory_order_release) == readOffset)
    return status_code<AgentStatusCodeDomain>(AgentCode::MailboxIsEmpty);
...
valkyrie::AgentStatus                          valkyrie::AgentMailbox::tryReadMessageMC (function_ref<AgentStatus(AgentMessage&)> msgProc) noexcept {
  u32 syncOffset = syncMarker.load(std::memory_order_acq_rel);
  u32 readOffset = nextReadOffset.load();
  u32 nextOffset = 0;
  AgentMessage* pMessage;
...
valkyrie::AgentStatus                          valkyrie::AgentMailbox::tryReadMessageNonCoherent(function_ref<AgentStatus(AgentMessage &)> msgProc) noexcept {
  u32 readOffset;
  u32 nextOffset = 0;
  AgentMessage* pMessage;
