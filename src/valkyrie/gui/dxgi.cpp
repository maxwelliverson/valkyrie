...
namespace valkyrie::GUI::Internal::DXGI{
  namespace {
    ...
    struct alignas(16) static_array{
      ...
      constexpr static_array(Args&& ...args) noexcept
          : count(sizeof...(Args)), values{ std::forward<Args>(args)... }{}
      constexpr static_array(std::initializer_list<T> list) noexcept
          : count(list.size()){
    ...
    using MappingMapEntry = FlatMapEntry<DXGI_FORMAT, FormatMapping>;
    using FamilyMapEntry  = FlatMapEntry<DXGI_FORMAT, FormatFamily>;

    using MappingMapContainer = static_array<MappingMapEntry, 106>;
    using FamilyMapContainer  = static_array<FamilyMapEntry,  40>;

    using MappingMap = flat_map<Format, FormatMapping, MappingMapContainer>;
    using FamilyMap  = flat_map<Format, FormatFamily,  FamilyMapContainer>;
